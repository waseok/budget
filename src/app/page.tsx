        ...
        <div className="flex-1 p-8 max-w-[1400px] mx-auto w-full">
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center justify-between gap-4 flex-wrap">
              <h1 className="text-2xl font-bold text-slate-900 font-headline tracking-tight m-0">
                나의 예산 현황
              </h1>
              <div className="flex gap-3">
                <a
                  href="/budgets"
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-2xl border border-slate-200 text-slate-700 hover:bg-slate-50 font-headline font-semibold text-sm transition-colors"
                >
                  <span
                ...
                <a
                  href="/expenses"
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-2xl bg-blue-600 hover:bg-blue-700 text-white font-headline font-semibold text-sm transition-colors shadow-sm"
                >
                  <span
                    className="material-symbols-outlined text-base leading-none"
                    style={{ fontVariationSettings: "'FILL' 0, 'wght' 400, 'GRAD' 0, 'opsz' 20" }}
          ...
          <div className="grid grid-cols-12 gap-6 mb-6">
            ...
            <div className="col-span-12 lg:col-span-8 bg-white rounded-3xl p-8 shadow-sm border border-slate-100">
              <p className="text-xs font-semibold text-slate-400 uppercase tracking-widest mb-1 font-headline">
                총 잔여 예산
              </p>
              <div className="flex items-end gap-3 mb-4">
                <span className="text-5xl font-bold text-slate-900 font-headline tracking-tight leading-none">
                  {formatCurrency(totalRemaining)}
                </span>
                <span
                  className={`text-sm font-semibold px-2.5 py-1 rounded-full mb-1 ${
                    totalRemaining >= 0
              ...
              <div className="mb-6">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-sm font-semibold text-slate-700 font-headline">{usageDisplay}%</span>
                </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="bg-slate-50/80 rounded-2xl p-4">
                  ...
                  <p className="text-base font-bold text-slate-800 font-headline">{formatCurrency(totalBudget)}</p>
                </div>
                <div className="bg-slate-50/80 rounded-2xl p-4">
                  <p className="text-xs text-slate-400 font-medium mb-1">사용 금액</p>
                  <p className="text-base font-bold text-slate-800 font-headline">{formatCurrency(totalSpent)}</p>
                </div>
                <div className="bg-slate-50/80 rounded-2xl p-4">
                  <p className="text-xs text-slate-400 font-medium mb-1">위시리스트</p>
                  <p className="text-base font-bold text-slate-800 font-headline">{formatCurrency(wishlistBudget)}</p>
                </div>
              </div>
            </div>
            ...
            <div className="col-span-12 lg:col-span-4 flex flex-col gap-4">
              ...
              <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 flex-1">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-xs font-semibold text-slate-400 uppercase tracking-widest font-headline">
                    사용 현황
                  </p>
                </div>
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-semibold text-slate-800 font-headline">
              ...
              <div className="bg-blue-600 rounded-3xl p-6 shadow-sm">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <p className="text-xs font-semibold text-blue-200 uppercase tracking-widest font-headline">
                    팁
                  </p>
                </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                <div className="bg-white rounded-2xl p-5 shadow-sm border border-slate-100">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <p className="text-xs font-semibold text-blue-600 uppercase tracking-wide font-headline">전체 예산</p>
                  </div>
                  <p className="text-xl font-bold text-slate-900 font-headline">{formatCurrency(totalBudget)}</p>
                ...
                <div className="bg-white rounded-2xl p-5 shadow-sm border border-slate-100">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <p className="text-xs font-semibold text-orange-500 uppercase tracking-wide font-headline">누적 지출</p>
                  </div>
                  <p className="text-xl font-bold text-slate-900 font-headline">{formatCurrency(totalSpent)}</p>
                ...
                <div className="bg-white rounded-2xl p-5 shadow-sm border border-slate-100">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <p className="text-xs font-semibold text-emerald-600 uppercase tracking-wide font-headline">남은 예산</p>
                  </div>
                  <p className={`text-xl font-bold font-headline ${totalRemaining < 0 ? "text-red-600" : "text-slate-900"}`}>
                    {formatCurrency(totalRemaining)}
                  </p>
                ...
                <div className="bg-white rounded-2xl p-5 shadow-sm border border-slate-100">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <p className="text-xs font-semibold text-pink-600 uppercase tracking-wide font-headline">위시리스트</p>
                  </div>
                  <p className="text-xl font-bold text-slate-900 font-headline">{formatCurrency(wishlistBudget)}</p>
                ...
                <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 mb-6">
                  <div className="flex items-center justify-between mb-5">
                    <div>
                      ...
                      <h2 className="text-lg font-bold text-slate-900 font-headline m-0">예산별 사용률</h2>
                    </div>
                    <a href="/budgets" className="text-sm font-semibold text-blue-600 hover:text-blue-700 font-headline transition-colors">
                      전체 보기
                    </a>
                  </div>
